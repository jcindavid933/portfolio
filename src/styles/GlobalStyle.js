...
const GlobalStyle = createGlobalStyle`
  ...
  @font-face {
    ...
    src: url(${fontFamilies.FranklinGothicDemiRegulartff}) format('truetype'),
    url(${fontFamilies.FranklinGothicDemiRegulartff}) format('truetype'),
    font-weight: 300;
    font-style: normal;
    font-display: auto;
  }
